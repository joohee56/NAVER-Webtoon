...
public class WebtoonRankingService {
    ...
    public List<WebtoonRankingDto> updateRanking(int offset, int limit) {
        ...
        while(idx < findNewRankings.size()) {
            ...
            FindNewRanking findNewRanking = findNewRankings.get(idx);
            ...
            WebtoonRanking webtoonRanking = WebtoonRanking.create(webtoon, ranking, status, findNewRanking.getTotalLikeCount());
            newRankings.add(webtoonRanking);
            idx++;
        }
